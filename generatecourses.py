...
from deanzadb import subject_to_courses,igetc_prefs,prefix_options, Course, igetc_rankings, lab_set

from generateschedule import create_balanced_schedule
...
def process(pdf_data,  qmax, smax, passed_interest):
  ...
  return create_balanced_schedule(valuess,qmax,smax)
